...
function Services() {
    return (
        <section className="py-20 px-8 md:px-12 lg:px-24 text-center bg-gray-100 even:bg-gray-300" id="services">
            <h2 className="text-3xl md:text-4xl font-serif text-gray-800 mb-10">
                Our Services
            </h2>
            <ul className="list-none max-w-xl mx-auto text-lg text-gray-600">
